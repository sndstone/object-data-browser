...
class IosEngineService
  ...
  IosEngineService({
    ...
    EngineService? fallback,
            ...
            channel ?? const MethodChannel('s3_browser_crossplat/ios_engine'),
    ...
    try {
      ...
      return items.map((entry) {
        ...
        return EngineDescriptor(
          id: value['id'] as String? ?? 'ios',
          label: value['label'] as String? ?? 'iOS Engine',
          language: value['language'] as String? ?? 'native',
          version: value['version'] as String? ?? '2.2.5',
  ...
  Future<Map<String, Object?>> _dispatch({
    ...
    final requestId =
        'ios-${DateTime.now().microsecondsSinceEpoch}-$method-$engineId';
    ...
    _emitLog(
      ...
      message: 'Dispatching $method via iOS adapter for engine $engineId.',
      source: 'debug',
      params: params,
      requestId: requestId,
      engineId: engineId,
    ...
    try {
      ...
      _emitLog(
        ...
        category: 'EngineDispatch',
        message:
            'iOS adapter completed $method via $engineId in ${latencyMs}ms.',
        source: 'debug',
        params: params,
        requestId: requestId,
        engineId: engineId,
      ...
      throw EngineException(
        ...
        message: error.message ?? 'iOS engine bridge failed.',
    ...
    switch (method) {
      ...
      default:
        throw const EngineException(
          ...
          message: 'iOS engine plugin is unavailable.',
        );
    }
  }
